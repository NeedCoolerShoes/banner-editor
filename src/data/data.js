const COLORS_1_8 = [
  {title: "Black", name: "black", code: 0, color: "#1d1d21", encode:"a"},
  {title: "Dark Gray", name: "gray", code: 8, color: "#474f52", encode:"i"},
  {title: "Gray", name: "light_gray", code: 7, color: "#9d9d97", encode:"h"},
  {title: "White", name: "white", code: 15, color: "#f9fffe", encode:"p"},
  {title: "Pink", name: "pink", code: 9, color: "#f38baa", encode:"j"},
  {title: "Magenta", name: "magenta", code: 13, color: "#c74ebd", encode:"n"},
  {title: "Purple", name: "purple", code: 5, color: "#8932b8", encode:"f"},
  {title: "Blue", name: "blue", code: 4, color: "#3c44aa", encode:"e"},
  {title: "Cyan", name: "cyan", code: 6, color: "#169c9c", encode:"g"},
  {title: "Light Blue", name: "light_blue", code: 12, color: "#3ab3da", encode:"m"},
  {title: "Green", name: "green", code: 2, color: "#5e7c16", encode:"c"},
  {title: "Lime", name: "lime", code: 10, color: "#80c71f", encode:"k"},
  {title: "Yellow", name: "yellow", code: 11, color: "#fed83d", encode:"l"},
  {title: "Orange", name: "orange", code: 14, color: "#f9801d", encode:"o"},
  {title: "Brown", name: "brown", code: 3, color: "#835432", encode:"d"},
  {title: "Red", name: "red", code: 1, color: "#b02e26", encode:"b"}
]

const COLORS_1_13 = [
  {title: "Black", name: "black", code: 15, color: "#1d1d21", encode:"a"},
  {title: "Dark Gray", name: "gray", code: 7, color: "#474f52", encode:"i"},
  {title: "Gray", name: "light_gray", code: 8, color: "#9d9d97", encode:"h"},
  {title: "White", name: "white", code: 0, color: "#f9fffe", encode:"p"},
  {title: "Pink", name: "pink", code: 6, color: "#f38baa", encode:"j"},
  {title: "Magenta", name: "magenta", code: 2, color: "#c74ebd", encode:"n"},
  {title: "Purple", name: "purple", code: 10, color: "#8932b8", encode:"f"},
  {title: "Blue", name: "blue", code: 11, color: "#3c44aa", encode:"e"},
  {title: "Cyan", name: "cyan", code: 9, color: "#169c9c", encode:"g"},
  {title: "Light Blue", name: "light_blue", code: 3, color: "#3ab3da", encode:"m"},
  {title: "Green", name: "green", code: 13, color: "#5e7c16", encode:"c"},
  {title: "Lime", name: "lime", code: 5, color: "#80c71f", encode:"k"},
  {title: "Yellow", name: "yellow", code: 4, color: "#fed83d", encode:"l"},
  {title: "Orange", name: "orange", code: 1, color: "#f9801d", encode:"o"},
  {title: "Brown", name: "brown", code: 12, color: "#835432", encode:"d"},
  {title: "Red", name: "red", code: 14, color: "#b02e26", encode:"b"}
]

const COLORS_1_21 = [
  {title: "Black", name: "black", code: "black", color: "#1d1d21", encode:"a"},
  {title: "Dark Gray", name: "gray", code: "gray", color: "#474f52", encode:"i"},
  {title: "Gray", name: "light_gray", code: "light_gray", color: "#9d9d97", encode:"h"},
  {title: "White", name: "white", code: "white", color: "#f9fffe", encode:"p"},
  {title: "Pink", name: "pink", code: "pink", color: "#f38baa", encode:"j"},
  {title: "Magenta", name: "magenta", code: "magenta", color: "#c74ebd", encode:"n"},
  {title: "Purple", name: "purple", code: "purple", color: "#8932b8", encode:"f"},
  {title: "Blue", name: "blue", code: "blue", color: "#3c44aa", encode:"e"},
  {title: "Cyan", name: "cyan", code: "cyan", color: "#169c9c", encode:"g"},
  {title: "Light Blue", name: "light_blue", code: "light_blue", color: "#3ab3da", encode:"m"},
  {title: "Green", name: "green", code: "green", color: "#5e7c16", encode:"c"},
  {title: "Lime", name: "lime", code: "lime", color: "#80c71f", encode:"k"},
  {title: "Yellow", name: "yellow", code: "yellow", color: "#fed83d", encode:"l"},
  {title: "Orange", name: "orange", code: "orange", color: "#f9801d", encode:"o"},
  {title: "Brown", name: "brown", code: "brown", color: "#835432", encode:"d"},
  {title: "Red", name: "red", code: "red", color: "#b02e26", encode:"b"}
]
...
export {COLORS_1_8, COLORS_1_13, COLORS_1_21, PATTERNS_1_8, PATTERNS_1_16, PATTERNS_1_21};